...
* generated by Xtext
*/
package de.grammarcraft.flow.ui.contentassist.antlr;
...
public class FlowParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.grammarcraft.flow.ui.contentassist.antlr.internal.InternalFlowParser createParser() {
		de.grammarcraft.flow.ui.contentassist.antlr.internal.InternalFlowParser result = new de.grammarcraft.flow.ui.contentassist.antlr.internal.InternalFlowParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getFunctionUnitAccess().getAlternatives_2(), "rule__FunctionUnit__Alternatives_2");
					...
					put(grammarAccess.getFunctionUnitAccess().getGroup(), "rule__FunctionUnit__Group__0");
					put(grammarAccess.getFunctionUnitAccess().getGroup_2_1(), "rule__FunctionUnit__Group_2_1__0");
					put(grammarAccess.getStreamAccess().getGroup(), "rule__Stream__Group__0");
					put(grammarAccess.getOwnPortAccess().getGroup(), "rule__OwnPort__Group__0");
					put(grammarAccess.getForeignPortAccess().getGroup(), "rule__ForeignPort__Group__0");
					put(grammarAccess.getExternalReferencePortAccess().getGroup(), "rule__ExternalReferencePort__Group__0");
					put(grammarAccess.getNamedPortAccess().getGroup(), "rule__NamedPort__Group__0");
					put(grammarAccess.getTypeLessConnectionAccess().getGroup(), "rule__TypeLessConnection__Group__0");
					put(grammarAccess.getTypeAnnotatedConnectionAccess().getGroup(), "rule__TypeAnnotatedConnection__Group__0");
					...
					put(grammarAccess.getFunctionUnitAccess().getNameAssignment_1(), "rule__FunctionUnit__NameAssignment_1");
					put(grammarAccess.getFunctionUnitAccess().getStreamsAssignment_2_0(), "rule__FunctionUnit__StreamsAssignment_2_0");
					put(grammarAccess.getFunctionUnitAccess().getAliasTypeAssignment_2_1_1(), "rule__FunctionUnit__AliasTypeAssignment_2_1_1");
					put(grammarAccess.getStreamAccess().getLeftPortAssignment_0(), "rule__Stream__LeftPortAssignment_0");
					put(grammarAccess.getStreamAccess().getConnectionAssignment_1(), "rule__Stream__ConnectionAssignment_1");
					put(grammarAccess.getStreamAccess().getRightPortAssignment_2(), "rule__Stream__RightPortAssignment_2");
					put(grammarAccess.getOwnPortAccess().getPortAssignment_1(), "rule__OwnPort__PortAssignment_1");
					put(grammarAccess.getForeignPortAccess().getFunctionUnitAssignment_0(), "rule__ForeignPort__FunctionUnitAssignment_0");
					put(grammarAccess.getForeignPortAccess().getPortAssignment_1(), "rule__ForeignPort__PortAssignment_1");
					put(grammarAccess.getExternalReferencePortAccess().getTypeAssignment_1(), "rule__ExternalReferencePort__TypeAssignment_1");
					put(grammarAccess.getExternalReferencePortAccess().getPortAssignment_2(), "rule__ExternalReferencePort__PortAssignment_2");
					put(grammarAccess.getNamedPortAccess().getNameAssignment_1(), "rule__NamedPort__NameAssignment_1");
					put(grammarAccess.getTypeAnnotatedConnectionAccess().getMsgTypeAssignment_1(), "rule__TypeAnnotatedConnection__MsgTypeAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.grammarcraft.flow.ui.contentassist.antlr.internal.InternalFlowParser typedParser = (de.grammarcraft.flow.ui.contentassist.antlr.internal.InternalFlowParser) parser;
