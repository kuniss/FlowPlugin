...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getImportsXImportSectionParserRuleCall_1_0()); 
	    }
...
(	otherlv_0='flow' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getFunctionUnitAccess().getFlowKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getFunctionUnitAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionUnitAccess().getStreamsStreamParserRuleCall_2_0_0()); 
	    }
		lv_streams_2_0=ruleStream		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFunctionUnitRule());
	        }
       		add(
       			$current, 
       			"streams",
    ...
    |(	otherlv_3='alias' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getFunctionUnitAccess().getAliasKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionUnitAccess().getAliasTypeJvmTypeReferenceParserRuleCall_2_1_1_0()); 
	    }
		lv_aliasType_4_0=ruleJvmTypeReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFunctionUnitRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getStreamAccess().getLeftPortPortParserRuleCall_0_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getStreamAccess().getConnectionConnectionParserRuleCall_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getStreamAccess().getRightPortPortParserRuleCall_2_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getStreamAccess().getSemicolonKeyword_3());
    }
)
;
...
(
    { 
        newCompositeNode(grammarAccess.getPortAccess().getOwnPortParserRuleCall_0()); 
    }
    this_OwnPort_0=ruleOwnPort
    { 
        $current = $this_OwnPort_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getPortAccess().getForeignPortParserRuleCall_1()); 
    }
    this_ForeignPort_1=ruleForeignPort
    { 
        $current = $this_ForeignPort_1.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getPortAccess().getExternalReferencePortParserRuleCall_2()); 
    }
    this_ExternalReferencePort_2=ruleExternalReferencePort
    { 
        $current = $this_ExternalReferencePort_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleOwnPort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getOwnPortRule()); }
	 iv_ruleOwnPort=ruleOwnPort 
	 { $current=$iv_ruleOwnPort.current; } 
	 EOF 
;

// Rule OwnPort
ruleOwnPort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getOwnPortAccess().getOwnPortAction_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getOwnPortAccess().getPortNamedPortParserRuleCall_1_0()); 
	    }
		lv_port_1_0=ruleNamedPort		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOwnPortRule());
	        }
       		set(
       			$current, 
       			"port",
...
entryRuleForeignPort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getForeignPortRule()); }
	 iv_ruleForeignPort=ruleForeignPort 
	 { $current=$iv_ruleForeignPort.current; } 
	 EOF 
;

// Rule ForeignPort
ruleForeignPort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getForeignPortRule());
	        }
        }
		{ 
	        newCompositeNode(grammarAccess.getForeignPortAccess().getFunctionUnitFunctionUnitCrossReference_0_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getForeignPortAccess().getPortNamedPortParserRuleCall_1_0()); 
	    }
		lv_port_1_0=ruleNamedPort		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getForeignPortRule());
	        }
       		set(
       			$current, 
       			"port",
...
entryRuleExternalReferencePort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getExternalReferencePortRule()); }
	 iv_ruleExternalReferencePort=ruleExternalReferencePort 
	 { $current=$iv_ruleExternalReferencePort.current; } 
	 EOF 
;

// Rule ExternalReferencePort
ruleExternalReferencePort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='@' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getExternalReferencePortAccess().getCommercialAtKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getExternalReferencePortAccess().getTypeJvmTypeReferenceParserRuleCall_1_0()); 
	    }
		lv_type_1_0=ruleJvmTypeReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExternalReferencePortRule());
	        }
       		set(
       			$current, 
       			"type",
...
(
		{ 
	        newCompositeNode(grammarAccess.getExternalReferencePortAccess().getPortNamedPortParserRuleCall_2_0()); 
	    }
		lv_port_2_0=ruleNamedPort		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExternalReferencePortRule());
	        }
       		set(
...
(	otherlv_0=':' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getNamedPortAccess().getColonKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
...
(
    { 
        newCompositeNode(grammarAccess.getConnectionAccess().getTypeLessConnectionParserRuleCall_0()); 
    }
    this_TypeLessConnection_0=ruleTypeLessConnection
    { 
        $current = $this_TypeLessConnection_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getConnectionAccess().getTypeAnnotatedConnectionParserRuleCall_1()); 
    }
    this_TypeAnnotatedConnection_1=ruleTypeAnnotatedConnection
    { 
        $current = $this_TypeAnnotatedConnection_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleTypeLessConnection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTypeLessConnectionRule()); }
	 iv_ruleTypeLessConnection=ruleTypeLessConnection 
	 { $current=$iv_ruleTypeLessConnection.current; } 
	 EOF 
;

// Rule TypeLessConnection
ruleTypeLessConnection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='->' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTypeLessConnectionAccess().getHyphenMinusGreaterThanSignKeyword_0());
    }
(
    {
        $current = forceCreateModelElement(
            grammarAccess.getTypeLessConnectionAccess().getTypeLessConnectionAction_1(),
            $current);
    }
))
;
...
entryRuleTypeAnnotatedConnection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTypeAnnotatedConnectionRule()); }
	 iv_ruleTypeAnnotatedConnection=ruleTypeAnnotatedConnection 
	 { $current=$iv_ruleTypeAnnotatedConnection.current; } 
	 EOF 
;

// Rule TypeAnnotatedConnection
ruleTypeAnnotatedConnection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTypeAnnotatedConnectionAccess().getHyphenMinusKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAnnotatedConnectionAccess().getMsgTypeJvmTypeReferenceParserRuleCall_1_0()); 
	    }
		lv_msgType_1_0=ruleJvmTypeReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAnnotatedConnectionRule());
	        }
       		set(
       			$current, 
       			"msgType",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getTypeAnnotatedConnectionAccess().getHyphenMinusGreaterThanSignKeyword_2());
    }
)
;
