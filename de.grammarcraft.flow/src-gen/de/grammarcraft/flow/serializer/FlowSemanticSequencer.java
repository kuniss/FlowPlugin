package de.grammarcraft.flow.serializer;
...
public class FlowSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == FlowPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case FlowPackage.EXTERNAL_REFERENCE_PORT:
				if(context == grammarAccess.getExternalReferencePortRule() ||
				   context == grammarAccess.getPortRule()) {
					sequence_ExternalReferencePort(context, (ExternalReferencePort) semanticObject); 
					return; 
				}
				else break;
			case FlowPackage.FOREIGN_PORT:
				if(context == grammarAccess.getForeignPortRule() ||
				   context == grammarAccess.getPortRule()) {
					sequence_ForeignPort(context, (ForeignPort) semanticObject); 
					return; 
				}
				else break;
			case FlowPackage.FUNCTION_UNIT:
				if(context == grammarAccess.getFunctionUnitRule()) {
					sequence_FunctionUnit(context, (FunctionUnit) semanticObject); 
					return; 
				}
				else break;
			...
			case FlowPackage.OWN_PORT:
				if(context == grammarAccess.getOwnPortRule() ||
				   context == grammarAccess.getPortRule()) {
					sequence_OwnPort(context, (OwnPort) semanticObject); 
					return; 
				}
				else break;
			...
			case FlowPackage.TYPE_ANNOTATED_CONNECTION:
				if(context == grammarAccess.getConnectionRule() ||
				   context == grammarAccess.getTypeAnnotatedConnectionRule()) {
					sequence_TypeAnnotatedConnection(context, (TypeAnnotatedConnection) semanticObject); 
					return; 
				}
				else break;
			case FlowPackage.TYPE_LESS_CONNECTION:
				if(context == grammarAccess.getConnectionRule() ||
				   context == grammarAccess.getTypeLessConnectionRule()) {
					sequence_TypeLessConnection(context, (TypeLessConnection) semanticObject); 
					return; 
				}
				else break;
			}
	 ...
	 */
	protected void sequence_ExternalReferencePort(EObject context, ExternalReferencePort semanticObject) {
	 ...
	 */
	protected void sequence_ForeignPort(EObject context, ForeignPort semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=ID (streams+=Stream* | aliasType=JvmTypeReference))
	 */
	protected void sequence_FunctionUnit(EObject context, FunctionUnit semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName? imports=XImportSection? functionUnits+=FunctionUnit*)
	 */
	 ...
	 *     port=NamedPort
	 */
	protected void sequence_OwnPort(EObject context, OwnPort semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, FlowPackage.Literals.PORT__PORT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FlowPackage.Literals.PORT__PORT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getOwnPortAccess().getPortNamedPortParserRuleCall_1_0(), semanticObject.getPort());
		feeder.finish();
	}
	...
	protected void sequence_Stream(EObject context, Stream semanticObject) {
		if(errorAcceptor != null) {
			...
			if(transientValues.isValueTransient(semanticObject, FlowPackage.Literals.STREAM__CONNECTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FlowPackage.Literals.STREAM__CONNECTION));
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStreamAccess().getLeftPortPortParserRuleCall_0_0(), semanticObject.getLeftPort());
		feeder.accept(grammarAccess.getStreamAccess().getConnectionConnectionParserRuleCall_1_0(), semanticObject.getConnection());
		feeder.accept(grammarAccess.getStreamAccess().getRightPortPortParserRuleCall_2_0(), semanticObject.getRightPort());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_TypeAnnotatedConnection(EObject context, TypeAnnotatedConnection semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, FlowPackage.Literals.TYPE_ANNOTATED_CONNECTION__MSG_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FlowPackage.Literals.TYPE_ANNOTATED_CONNECTION__MSG_TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getTypeAnnotatedConnectionAccess().getMsgTypeJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getMsgType());
		feeder.finish();
	}
	 ...
	 *     {TypeLessConnection}
	 */
	protected void sequence_TypeLessConnection(EObject context, TypeLessConnection semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
